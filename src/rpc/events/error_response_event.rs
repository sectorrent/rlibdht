...
pub struct ErrorResponseEvent<'a> {
...
impl<'a> ErrorResponseEvent<'a> {
    ...
    pub fn get_request(&mut self) -> Option<&dyn MessageBase> {
        self.request
    }
...
impl<'a> Event for ErrorResponseEvent<'a> {
...
impl<'a> MessageEvent for ErrorResponseEvent<'a> {
